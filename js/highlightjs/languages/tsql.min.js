    ...
    return S => ({
      ...
      contains: [
        ...
        },
        {
          className: 'meta',
          begin:
            '^[\\t ]*:(!!|connect|error|exit|on\\s+error|5out|quit|r|reset|setvar|10)',
          end: '$',
          relevance: 0
        }
      ]
